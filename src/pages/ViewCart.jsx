...
const CartPage = () => {
  ...
  const fetchCartData = async (userId) => {
    try {
      ...
      // Step 3: Update the Redux state with the updated cart data
  ...
  useEffect(() => {
    ...
    if (currentUser) {
      ...
      // fetchCartProductDetail(cartItems.productId);
      //   console.log("cartItem:",cartItems)
    }
  }, [currentUser]);
        ...
        <div className="flex flex-col h-screen justify-center bg-transparent">
          <center className="">
            ...
            <div className="mt-4 tracking-widest">
              <span className="block text-6xl text-gray-500 my-5">
                <span>Opps !!</span>
              </span>
